...
import static com.linxiangqu.shop.photopicker.PhotoPreview.EXTRA_ACTION;
import static com.linxiangqu.shop.photopicker.PhotoPreview.EXTRA_CURRENT_ITEM;
import static com.linxiangqu.shop.photopicker.PhotoPreview.EXTRA_PHOTOS;
import static com.linxiangqu.shop.photopicker.PhotoPreview.EXTRA_SHOW_DELETE;
...
public class PhotoPagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (action == MultiPickResultView.ACTION_SELECT) {
            titlebar.setLeft(getApplicationContext().getResources().getDrawable(R.mipmap.backa_sj), null, new View.OnClickListener() {
                @Override
