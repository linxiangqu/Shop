...
/**
 * Created by linxiangqu on 2016/8/6.
 */
public class TopicGoodsRecyclerAdapter extends RecyclerView.Adapter<TopicGoodsRecyclerAdapter.MyViewHolder> {

    private Context mContext;
    private List<QueryTopicGoods.MallTopicGoodsDTOsBean> mList;
    private OnItemClickListener onItemClickListener;

    public interface OnItemClickListener {

        void onItemChild(View view, int position, QueryTopicGoods.MallTopicGoodsDTOsBean mallTopicGoodsDTOs);
    }
    ...
    public void show(List<QueryTopicGoods.MallTopicGoodsDTOsBean> mList) {
        this.mList = mList;
        notifyDataSetChanged();
    }

    public TopicGoodsRecyclerAdapter(Context mContext, List<QueryTopicGoods.MallTopicGoodsDTOsBean> mList) {
